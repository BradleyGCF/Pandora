...
export const AuthenticationError = createErrorFactory(
  "AuthenticationError",
  "Email o contraseña inválidos",
);
export const AuthorizationError = createErrorFactory(
  "AuthorizationError",
  "No tiene permisos suficientes",
);
export const NotFoundError = createErrorFactory(
  "NotFoundError",
  "Página no encontrada",
);
export const TimeoutError = createErrorFactory(
  "TimeoutError",
  "Error de timeout. Intente de nuevo más tarde",
);
export const ConflictError = createErrorFactory(
  "ConflictError",
